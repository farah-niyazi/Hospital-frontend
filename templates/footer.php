        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-4 col-md-4 mb-4">
                ...
                <ul class="nav flex-column " >
                    ...
                    <li class="nav-item"><a class="nav-link" href="#" >Dormamu Clinic</a></li>
                </ul>
            </div>
            ...
            <span>WebSite Content Managed by Pulwama Hospital, District Pulwama</span>
            <p>Design and Developed by NIELIT J&K, Srinagar</p>

            <span>Hosted by NIC Server through Pulwama Hospital, District Pulwama</span>
        </div>
    </div>
</footer>
<!-- Vendor JS Files -->
