...
<div class="col-md-9"><div class="d-flex justify-content-end">
        <div class="p-2 bd-highlight">  <select class="form-select" aria-label="Default select example">
        ...
        <div class="p-2 bd-highlight"><button class="btn btn-primary">Login/Admin</button></div>
    </div></div>
        </div>
    </div>
    <?php
