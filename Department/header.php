...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.gstatic.com" el="preconnect">
    ...
    <link href="../assets/vendor/simple-datatables/style.css" rel="stylesheet">
        <link href="dept_css.css" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-light ">
    <div class="container-fluid alignment-centre "style="background-color: #008080;>
        <a class="navbar-brand me-auto d-lg-none d-md-none d-sm-block " href="#"></a>
...
<a href="../department.php"><i class="bi bi-arrow-left-circle-fill" style="color:white; font-size:x-large;"></i></a>
